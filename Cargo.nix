...
let
  nixifiedLockHash = "28b5cbabdf981e0950f9e80eba42f4297efc41d40a0d19c88ec9fb4555d38fa1";
...
if !lockHashIgnored && (nixifiedLockHash != currentLockHash) then
  ...
  in
  {
    ...
    "registry+https://github.com/rust-lang/crates.io-index".cxx."1.0.89" = overridableMkRustCrate (profileName: rec {
      ...
      dependencies = {
        cxxbridge_macro = (buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".cxxbridge-macro."1.0.89" { profileName = "__noProfile"; }).out;
      ...
      buildDependencies = {
        ...
        cxxbridge_flags = (buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".cxxbridge-flags."1.0.89" { profileName = "__noProfile"; }).out;
      };
    });
    ...
    "unknown".hatysa."0.3.0" = overridableMkRustCrate (profileName: rec {
      ...
      dependencies = {
        ...
        iota_orionis = (rustPackages."unknown".iota-orionis."0.3.0" { inherit profileName; }).out;
        serenity = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".serenity."0.11.5" { inherit profileName; }).out;
    ...
    "registry+https://github.com/rust-lang/crates.io-index".iana-time-zone-haiku."0.1.1" = overridableMkRustCrate (profileName: rec {
      ...
      dependencies = {
        cxx = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".cxx."1.0.89" { inherit profileName; }).out;
      };
      buildDependencies = {
        cxx_build = (buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".cxx-build."1.0.89" { profileName = "__noProfile"; }).out;
      };
    });
    ...
    "registry+https://github.com/rust-lang/crates.io-index".reqwest."0.11.14" = overridableMkRustCrate (profileName: rec {
      ...
      dependencies = {
        ...
        serde_json = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_json."1.0.92" { inherit profileName; }).out;
    ...
    "registry+https://github.com/rust-lang/crates.io-index".serde-value."0.7.0" = overridableMkRustCrate (profileName: rec {
      ...
      dependencies = {
        ordered_float = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".ordered-float."2.10.0" { inherit profileName; }).out;
        serde = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.152" { inherit profileName; }).out;
      };
    });
    ...
    "registry+https://github.com/rust-lang/crates.io-index".serenity."0.11.5" = overridableMkRustCrate (profileName: rec {
      ...
      dependencies = {
        ...
        serde_json = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_json."1.0.92" { inherit profileName; }).out;
        dep_time = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".time."0.3.17" { inherit profileName; }).out;
        tokio = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio."1.25.0" { inherit profileName; }).out;
        tracing = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing."0.1.37" { inherit profileName; }).out;
